...
function startQuiz() {
	...
	for (let quizIndex = 0; quizIndex < quizQuestions.length; quizIndex++) {
		...
		`<br>
		&nbsp;
		<form class="questionForm form-check form-check-inline">
		<input class="form-check-input" type="radio" name="#" value="1" aria-label="Checkbox for YES" required> &nbsp; &nbsp; &nbsp; 
		<input class="form-check-input" type="radio" name="#" value="0" aria-label="Checkbox for NO" required>
		</form>
		&nbsp;&nbsp;&nbsp;`
